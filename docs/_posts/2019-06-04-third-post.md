...
![Deadline image]({{site.baseurl}}/images/compositedesignpattern.png "Composite Design Pattern"){:height="50%" width="50%"}
...
![Deadline image]({{site.baseurl}}/images/modelviewcontroller.png "Model View Controller"){:height="50%" width="50%"}
